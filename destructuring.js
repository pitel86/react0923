...
let {name, ...nuevoPepito} = pepito;


console.log(name)

console.log(nuevoPepito)
console.log(pepito)
...
const {info, results, pepe} = RickMortyApi

console.log(info, pepe)

const {pages} = RickMortyApi.info

console.log(pages)

const {count, ...newInfo} = RickMortyApi.info;
console.log(newInfo)

const numeros = [5, 8, 9, 78, 92]
const [numA, numB, ...numeros2] = numeros
